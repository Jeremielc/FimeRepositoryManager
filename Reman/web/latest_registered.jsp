                        ...
                        <%
                            ...
                            for (ToolArchiveFile taf : tools) {
                                ...
                                if (RegisterPageController.sessions.get(session).isAdmin()) {
                                    out.println("                                <div>");
                                    out.println("                                    <form style=\"float: left; margin-left: 5px;\" method=\"post\" action=\"Reman/latest/archive\">");
                                    out.println("                                        <button name=\"filename\" value=\"" + taf.getToolPath() + "\" class=\"btn btn-info\" type=\"submit\">Archive</button>");
                                    out.println("                                    </form>");
                                    out.println("                                </div>");
                                    out.println("                                <div>");
                                    out.println("                                    <form style=\"float: left; margin-left: 5px;\" method=\"post\" action=\"Reman/latest/remove\">");
